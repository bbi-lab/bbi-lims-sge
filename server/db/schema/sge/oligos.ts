...
export const haPcrProducts = pgTable('ha_pcr_products', {
    ...
    haPrimerReverseId: uuid('ha_primer_reverse_id').references(() => homologyArmPrimers.id),
...
export const haPuc19PcrProducts = pgTable('ha_puc19_pcr_products', {
    ...
    haPuc19PrimerForwardId: uuid('ha_puc19_primer_forward_id').references(() => homologyArmPuc19Primers.id),
    haPuc19PrimerReverseId: uuid('ha_puc19_primer_reverse_id').references(() => homologyArmPuc19Primers.id),
