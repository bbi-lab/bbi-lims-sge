CREATE TABLE "sg_rna_oligo_targets" (
	...
	"sg_rna_oligo_id" uuid,
	"target_id" uuid
);
--> statement-breakpoint
DROP VIEW "public"."view_sequencing_run_all_samples";--> statement-breakpoint
ALTER TABLE "sg_rna_oligos" DROP CONSTRAINT "sg_rna_oligos_target_id_targets_id_fk";
--> statement-breakpoint
ALTER TABLE "sg_rna_oligo_targets" ADD CONSTRAINT "sg_rna_oligo_targets_sg_rna_oligo_id_sg_rna_oligos_id_fk" FOREIGN KEY ("sg_rna_oligo_id") REFERENCES "public"."sg_rna_oligos"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sg_rna_oligo_targets" ADD CONSTRAINT "sg_rna_oligo_targets_target_id_targets_id_fk" FOREIGN KEY ("target_id") REFERENCES "public"."targets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "unique_sg_rna_oligo_target" ON "sg_rna_oligo_targets" USING btree ("sg_rna_oligo_id","target_id");--> statement-breakpoint
ALTER TABLE "sg_rna_oligos" DROP COLUMN "target_id";--> statement-breakpoint
