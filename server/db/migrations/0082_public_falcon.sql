DROP VIEW "public"."view_sequencing_run_errors";--> statement-breakpoint
...
ALTER TABLE "plates" DROP CONSTRAINT "sequencing_run_plate_type_check";--> statement-breakpoint
ALTER TABLE "plates" DROP CONSTRAINT "plates_sequencing_run_id_sequencing_runs_id_fk";
--> statement-breakpoint
ALTER TABLE "plates" DROP COLUMN "sequencing_run_id";--> statement-breakpoint
