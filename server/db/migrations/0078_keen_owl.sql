...
ALTER TABLE "plates" ADD COLUMN "plasmid_experiment_id" uuid;--> statement-breakpoint
ALTER TABLE "plates" ADD CONSTRAINT "plates_plasmid_experiment_id_plasmid_experiments_id_fk" FOREIGN KEY ("plasmid_experiment_id") REFERENCES "public"."plasmid_experiments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
