...
ALTER TABLE "pcr_experiments" DROP CONSTRAINT "pcr_experiments_cycle_id_cycles_id_fk";
--> statement-breakpoint
ALTER TABLE "pcr_experiments" DROP COLUMN "cycle_id";--> statement-breakpoint
