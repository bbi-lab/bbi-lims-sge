...
ALTER TABLE "pcr_experiments" DROP CONSTRAINT "preseq1_transfect_target_id_required";--> statement-breakpoint
ALTER TABLE "pcr_experiments" DROP CONSTRAINT "pcr_experiments_transfect_target_id_transfect_targets_id_fk";
--> statement-breakpoint
INSERT INTO "pcr_experiment_targets" ("pcr_experiment_id", "transfect_target_id") SELECT "id", "transfect_target_id" FROM "pcr_experiments" WHERE "transfect_target_id" IS NOT NULL ON CONFLICT DO NOTHING;--> statement-breakpoint
ALTER TABLE "pcr_experiments" DROP COLUMN "transfect_target_id";--> statement-breakpoint
