UPDATE "public"."plates" SET "plate_type" = 'ha-primer-storage' WHERE "plate_type" = 'ha-storage';--> statement-breakpoint
UPDATE "public"."plates" SET "plate_type" = 'amp-primer-storage' WHERE "plate_type" = 'amp-storage';--> statement-breakpoint
UPDATE "public"."plates" SET "plate_type" = 'lin-primer-storage' WHERE "plate_type" = 'lin-storage';--> statement-breakpoint
