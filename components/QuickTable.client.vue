...
<template>
    ...
    >
        ...
        <Column class="w-0" v-if="selectionMode=='multiple'" :selectionMode="selectionMode" :exportable="false"></Column>
        <Column class="whitespace-nowrap !p-0 w-0" v-if="props.canEdit" :exportable="false">
